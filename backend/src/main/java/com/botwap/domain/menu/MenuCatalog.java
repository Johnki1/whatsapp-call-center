 ...
 * en conversation_selection.option_key.</p>
 */
public final class MenuCatalog {
    ...
    public static List<MenuOption> mainMenu() {
        return List.of(
                ...
                new MenuOption("PERSONAL_INFO", "Informacion personal"),
                new MenuOption("SUPPORT", "Soporte tecnico")
        );
    }

    public static List<MenuOption> purchaseMenu() {
        return List.of(
                new MenuOption("INTERNET_MOBILE", "Internet movil"),
                new MenuOption("UNLIMITED_MINUTES", "Minutos ilimitados"),
    ...
    public static List<MenuOption> rechargeMenu() {
        return List.of(
                new MenuOption("RECHARGE_MY_LINE", "Recargar mi linea"),
                new MenuOption("RECHARGE_OTHER_NUMBER", "Recargar otro numero"),
    ...
    public static List<MenuOption> complaintMenu() {
        return List.of(
                new MenuOption("BILLING", "Facturacion"),
    ...
    public static List<MenuOption> personalInfoMenu() {
        return List.of(
                ...
                new MenuOption("UPDATE_DATA", "Actualizar datos")
        );
    }

    public static List<MenuOption> supportMenu() {
        return List.of(
                new MenuOption("APN_CONFIG", "Configuracion APN"),
                new MenuOption("CALLS_MESSAGES", "Llamadas y mensajes"),
                new MenuOption("SIGNAL_ISSUES", "Problemas de senal"),
                new MenuOption("CONFIG_GUIDES", "Guias de configuracion")
        );
    }
    ...
    public static List<MenuOption> complaintDetailMenu() {
        return List.of(
                new MenuOption("BILL_REVIEW", "Revision de factura"),
                new MenuOption("COMPENSATION", "Solicitar compensacion"),
    ...
    public static List<MenuOption> personalInfoDetailMenu() {
        return List.of(
                new MenuOption("LAST_MOVEMENTS", "Ultimos movimientos"),
                new MenuOption("AVAILABLE_BALANCE", "Saldo disponible"),
                new MenuOption("BILLING_DETAILS", "Datos de facturacion"),
                new MenuOption("LINE_STATUS", "Estado de linea")
        );
    }
    ...
    public static List<MenuOption> supportDetailMenu() {
        return List.of(
                new MenuOption("STEP_BY_STEP", "Guia paso a paso"),
                new MenuOption("VIDEO_TUTORIAL", "Video tutorial"),
                new MenuOption("MANUAL_CONFIG", "Configuracion manual"),
                new MenuOption("SELF_DIAGNOSTIC", "Autodiagnostico")
        );
    }
    ...
    public static List<MenuOption> productMenu() {
        return List.of(
                ...
                new MenuOption("UNLIMITED", "Ilimitado")
        );
    }

    public static List<MenuOption> identificationMenu() {
        return List.of(
                new MenuOption("CC", "Cedula de ciudadania"),
    ...
    public static List<MenuOption> confirmationMenu() {
        return List.of(
                ...
                new MenuOption("CHANGE_PACKAGE", "Cambiar paquete"),
